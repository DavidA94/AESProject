...
//                EmployeeRole = Enum.Parse(EmployeeRole, claims.First(n => n.Type == ClaimTypes.Role).Value)
//            };
...
//            try
//            {
//                return Enum.Parse(EmployeeRole, (((ClaimsIdentity)HttpContext.Current.User.Identity).Claims.First(id => id.Type == ClaimTypes.Role).Value));
//            }
//            catch (Exception)
//            {
//                return null;
